...
class Level(GameObject):
    ...
    def read(this, load_callback : typing.Callable[[int, str, int], typing.Any] = None, ignore_errors : bool = False):
        """Read level XML
        """
        this.objects : list[Object] = []
        this.properties = {}
    ...
    def export(this, filename : str = None, exportObjects : bool = False, saveImage : bool = True) -> bytes:
        """Export level
    ...
    def addObject(this, filename : str | Object, properties : dict = {}, pos : tuple[float, float] = (0, 0), name : str = 'Obj'):
        """Add object to level.
