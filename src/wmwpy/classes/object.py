...
class Object(GameObject):
    ...
    def getOffset(this) -> tuple[float,float]:
        ...
        this._background : list[Sprite] = []
        this._foreground : list[Sprite] = []
        this._child_sprites : list[Sprite] = []
        ...
        for sprite in this.sprites:
            ...
            if 'filename' in sprite.properties:
                ...
                if 'Tap_Button' in filename or 'Button' in filename:
                    this._child_sprites.append(sprite)
                    continue
    ...
    def background(this) -> Image.Image:
        ...
        for sprite in this._background:
            ...
            pos = this.truePos(sprite.pos, size, this.size, scale = this.scale, offset = this._offset)
    ...
    def export(this, path : str = None) -> bytes:
        ...
        for name in this.defaultProperties:
            etree.SubElement(DefaultProperties, 'Property', {'name': name, 'value': this.defaultProperties[name]})
    ...
    def getLevelXML(this, filename : str = None) -> etree.ElementBase:
    ...
    def saveGIF(this, filename = None, duration : int = 0, fps : float = 0):
...
class Shape(GameObject):
    ...
    def image(this) -> Image.Image:
        ...
        for n in range(len(this.points)):
            ...
            # line = line * [1, -1]
            line = numpy.array(this.truePos(line, (1, 1), size, offset))
