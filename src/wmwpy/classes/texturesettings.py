...
class Setting():
    def __init__(self, xml : etree.ElementBase = None, name : str = '', properties : dict[str, str] = {}) -> None:
...
class TextureSettings(GameObject):
    def __init__(
        ...
        if file == None:
            file = self.filesystem.get(joinPath(self.baseassets, '/Data/textureSettings.xml'))
    ...
    def add(self, name : str, properties : dict[str, str] | Setting = {}):
