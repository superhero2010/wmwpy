...
class WMP(Game):
    ...
    _LEVEL_MATERIALS = {
        "air": {'rgb': (255, 255, 255), 'type': 'solid', 'outlined': False},
        "dirt": {'rgb': (113, 91, 49), 'type': 'solid', 'image': '/Perry/Texture/materials_dirt.pvr', 'outlined': True, 'outline_color': (255, 255, 255), 'outline_thickness': 2},
        "stone": {'rgb': (71, 71, 71), 'type': 'solid', 'image': '/Perry/Textures/materials_stone_small.pvr', 'outlined': True, 'outline_color': (255, 255, 255), 'outline_thickness': 2},
        "ice": {'rgb': (64, 208, 255), 'type': 'solid', 'image': '/Perry/Textures/materials_ice.pvr', 'outlined': True, 'outline_color': (255, 255, 255), 'outline_thickness': 2},
        "water": {'rgb': (43, 33, 254), 'type': 'particle'},
        "steam": {'rgb': (0, 3, 143), 'type': 'particle'},
        "sludge": {'rgb': (20, 20, 20), 'type': 'particle'},
        "hot_sludge": {'rgb': (126, 44, 0), 'type': 'particle'},
        "cold_sludge": {'rgb': (27, 72, 88), 'type': 'particle'}
    }
