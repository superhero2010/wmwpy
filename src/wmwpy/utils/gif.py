...
class TransparentAnimatedGifConverter(object):
    ...
    def _process_pixels(self):
        ...
        self._transparent_pixels = set(
            idx for idx, alpha in
            enumerate(self._img_rgba.getchannel(channel = 'A').getdata())
    ...
    def _set_parsed_palette(self):
        ...
        self._img_p_parsedpalette = dict((idx, tuple(palette[idx * 3:idx * 3 + 3]))
...
def _create_animated_gif(images: List[Image],
